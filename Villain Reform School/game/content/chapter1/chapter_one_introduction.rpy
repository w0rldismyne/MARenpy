...
label introduction_meet_students:
    ...
    #elif introductionLocationsPage is 3:
...
label introduction_locations_1:

    $ introductionLocationsPage = 1

    menu:
        extend ""
        "Lecture Hall" if introductionHiroMet is False:
            jump introduction_lecture_hall
        "Field" if introductionMarikoMet is False:
            jump introduction_field
        "Hallway" if introductionYokuMet is False:
            jump introduction_hallway
        "Courtyard" if introductionUittoMet is False:
            jump introduction_courtyard
        "Stage" if introductionKitsuneMet is False:
            jump introduction_stage
        "Audio Visual Room" if introductionKazzMet is False:
            jump introduction_av
        "Other Locations":
            jump introduction_locations_2

label introduction_locations_2:

    $ introductionLocationsPage = 2

    menu:
        extend ""
        "Nurse's Office" if introductionOshinMet is False:
            jump introduction_nurse_office
        "Pond" if introductionIchitaMet is False:
            jump introduction_pond
        "Roof" if introductionTaigaMet is False:
            jump introduction_roof
        "Library" if introductionChiseiMet is False:
            jump introduction_library
        "Sewing Room" if introductionShomaMet is False:
            jump introduction_sewing_room
        "Gymnasium" if introductionSetsunaMet is False:
            jump introduction_gym
        "Other Locations":
            jump introduction_locations_3


label introduction_locations_3:

    $ introductionLocationsPage = 3

    menu:
        extend ""
        "Cafe" if introductionKietsuMet is False:
            jump introduction_cafe
        "Lab" if introductionMomokoMet is False:
            jump introduction_lab
        "Classroom" if introductionReiMet is False:
            jump introduction_classroom
        "Student Council Room" if introductionRiseMet is False:
            jump introduction_student_council_room
        "Forbidden Door" if introductionDyreMet is False:
            jump introduction_forbidden_door
        "Ampitheater" if introductionJonaMet is False:
            jump introduction_ampitheater
        "Other Locations":
            jump introduction_locations_1
...
label introduction_lecture_hall:
    ...
    if introductionHiroMet is False:
...
label introduction_field:
    ...
    if introductionMarikoMet is False:
...
label introduction_hallway:
    ...
    if introductionYokuMet is False:
...
label introduction_courtyard:
    ...
    if introductionUittoMet is False:
...
label introduction_stage:
    ...
    if introductionKitsuneMet is False:
...
label introduction_av:
    ...
    if introductionKazzMet is False:
...
label introduction_nurse_office:
    ...
    if introductionOshinMet is False:
...
label introduction_pond:
    ...
    if introductionIchitaMet is False:
...
label introduction_roof:
    ...
    if introductionTaigaMet is False:
...
label introduction_library:
    ...
    if introductionChiseiMet is False:
...
label introduction_sewing_room:
    ...
    if introductionShomaMet is False:
...
label introduction_gym:
    ...
    if introductionSetsunaMet is False:
...
label introduction_cafe:
    ...
    if introductionKietsuMet is False:
...
label introduction_lab:
    ...
    if introductionMomokoMet is False:
...
label introduction_classroom:
    ...
    if introductionReiMet is False:
...
label introduction_student_council_room:
    ...
    if introductionRiseMet is False:
...
label introduction_forbidden_door:
    ...
    if introductionDyreMet is False:
...
label introduction_ampitheater:
    ...
    if introductionJonaMet is False:
